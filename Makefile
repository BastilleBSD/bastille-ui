...
install:
	...
	@mkdir -p /usr/local/etc/bastille-ui
	@cp -Rv etc/bastille-ui/* /usr/local/etc/bastille-ui/
...
uninstall:
	@echo
	@echo "Removing BastilleBSD UI Server..."
	@rm -vf /usr/local/bin/bastille-ui
	@rm -rvf /usr/local/share/bastille-ui/web
	@rm -rvf /usr/local/share/bastille-ui/config.json.sample
	@echo
	@echo "Removing startup script..."
	@rm -vf /usr/local/etc/rc.d/bastille-ui
	@echo
	@echo "You may need to manually remove /usr/local/share/bastille-ui/config.json"
	@echo "if it is no longer needed."
	@echo